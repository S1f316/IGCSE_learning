...
添加新系统卡片的脚本
用法：
  python add_system_card.py <unit_id> <front_content> <back_content>
...
def main():
    if len(sys.argv) != 4:
        print("用法: python add_system_card.py <unit_id> <front_content> <back_content>")
        print("示例: python add_system_card.py unit1 '新单词' '新单词的解释'")
        sys.exit(1)
